// piece.ts
// Game piece logic for the TypeScript/HTML5 double
...
export const PIECE_SHAPES: PieceShape[] = [
  ...
  [
    ...
    [
      [CELL_RO, CELL_SK, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY]
    ],
    [
      [CELL_WG, CELL_EMPTY, CELL_EMPTY],
      [CELL_RU, CELL_EMPTY, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY]
    ],
    [
      [CELL_SK, CELL_LU, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY]
    ],
  ],
  ...
  [
    [
      [CELL_LU, CELL_EMPTY, CELL_EMPTY],
      [CELL_WG, CELL_EMPTY, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY]
    ],
    [
      [CELL_LO, CELL_SK, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY],
      [CELL_EMPTY, CELL_EMPTY, CELL_EMPTY]
    ],
    [
...
export class Piece {
  ...
  rotate() {
    ...
    if (this.shapes.length > 1) {
      ...
      // single-rotation pieces should not change their shape when rotated
      return;
    }
  }
